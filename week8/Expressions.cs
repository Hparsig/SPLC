...
using System.IO;
//using System.NotImplementException;
...
// Abstract syntax for function definitions.
  ...
  public class IfElseExpr : Expression {
    private readonly Expression e1, e2, e3;

    public IfElseExpr(Expression e1, Expression e2, Expression e3){
      this.e1 = e1;
      this.e2 = e2;
      this.e3 = e3;
    }
    ...
    public override Type Check(TEnv env, FEnv fEnv) {
      if( e1.Check(env, fEnv) != Type.boolType ) {
        throw new TypeException("The predicate is not of type bool");
      }
      if( e2.Check(env, fEnv) == Type.boolType || e3.Check(env, fEnv) == Type.boolType ){
        throw new TypeException("Neither of the branch expressions can be of Type bool.");
      }
      return Type.intType;
    }
  ...
  public enum Operator {
    Add, Sub, Mul, Div, Mod, Neg, Eq, Ne, Lt, Le, Gt, Ge, Not, And, Or, Bad
  }
